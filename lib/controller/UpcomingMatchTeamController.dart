...
class UpcomingMatchTeamController extends GetxController {
...
//  var dateValue = "";
  ...
  var teamId;
  UpcomingMatchTeamController(String this.teamId);
  ...
  void getData(String teamIdd) {
    // dateValue = nextDate;
    callUpcomingMatch(teamIdd);
  }
  ...
  callUpcomingMatch(String teamIDLocal) async {
    ...
    try {
      ...
      var data = await apiClient?.getSports(
          url:
              "https://allsportsapi2.p.rapidapi.com/api/american-football/team/$teamIDLocal/matches/next/1",
          body: map,
          context: Get.context!);
