...
import 'package:stattrack/controller/OldMatchTeamController.dart';
...
class MatchDetailsTeam extends StatefulWidget {
  final String from;
  final String teamId;

  MatchDetailsTeam({Key? key, required this.from, required this.teamId})
      : super(key: key);

  @override
  State<MatchDetailsTeam> createState() => _MatchDetailsTeamState();
}

class _MatchDetailsTeamState extends State<MatchDetailsTeam> {
  var oldMatchTeamController ;
  ...
  @override
  void initState() {
    oldMatchTeamController = Get.put(OldMatchTeamController(widget.teamId));
  ...
  Widget build(BuildContext context) {
    if (widget.from == "Upcoming") {
      ...
      matchID = oldMatchTeamController.matchId;
