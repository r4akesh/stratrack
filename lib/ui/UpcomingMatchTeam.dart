...
import '../controller/UpcomingMatchTeamController.dart';
...
class UpcomingMatchTeam extends StatelessWidget {
  String teamId="";
  UpcomingMatchTeam(String this.teamId);

  @override
  Widget build(BuildContext context) {
    return GetX<UpcomingMatchTeamController>(
        init: UpcomingMatchTeamController(teamId),
        builder: (controller) {
          return Column(
            children: [
              Expanded(
